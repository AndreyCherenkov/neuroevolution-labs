...
• Пространство: X = [0,24]×[0,12].
• Станция зарядки: центр (21.5,8.5), радиус 0.9, мощность Pcharge = 0.025 на шаг.
• Старт: (x0,y0) ∼ N((3.5,6.0), σ2I), σ = 1.8; клип: x ∈ [1.0,7.0], y ∈ [2.0,10.0].
• Ветер: wt = (wx,wy), wx,wy ∼ U(−0.11,0.11); обновление каждые 15 шагов.
• Препятствия: O1 : (10.0,2.0)−(11.5,5.5), O2 : (13.0,7.0)−(14.5,10.0), O3 : (16.5,3.5)−
(18.0, 6.5), O4 : (19.0,9.0) − (20.5,11.5).
"""
import numpy as np
